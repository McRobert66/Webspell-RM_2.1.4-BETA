...
<head>
    ...
    <!--<script src="../components/admin/js/jquery-3.5.1.min.js"></script>-->
    ...
    <div id="wrapper">
      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          ...
          <!-- Copy -->
          <div class="copy">
            <em>&nbsp;&copy; 2022 Admin Template by <a href="https://www.webspell-rm.de" target="_blank" rel="noopener">Webspell-RM</a></em>
          </div>
        </div>
      </div>
    <!-- /.navbar-static-side -->
