...
/*.foto {
background:
-webkit-linear-gradient(rgba(var(--bs-login_color-rgb), 0.6), rgba(var(--bs-login_color-rgb), 0.6)),
url(/includes/themes/'.$ds['pfad'].'/images/'.$ds['reg_pic'].') no-repeat center center fixed; 
background:
linear-gradient(rgba(var(--bs-login_color-rgb), 0.6), rgba(var(--bs-login_color-rgb), 0.6)),
url(/includes/themes/'.$ds['pfad'].'/images/'.$ds['reg_pic'].') no-repeat center center fixed;    
}*/
