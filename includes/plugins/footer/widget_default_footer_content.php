...
if(mysqli_num_rows($ergebnis)){
	while ($db = mysqli_fetch_array($ergebnis)) {
        ...
        if ($db[ 'twitch' ] != '') {
            $twitch = '<a href="' . htmlspecialchars($db[ 'twitch' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-twitch fa-2x fa-fw"></i></a>';
        } else {
            $twitch = 'n_a';
        }

        if ($db[ 'facebook' ] != '') {
            $facebook = '<a href="' . htmlspecialchars($db[ 'facebook' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-facebook fa-2x fa-fw"></i></a>';
        } else {
            $facebook = 'n_a';
        }

        if ($db[ 'twitter' ] != '') {
            $twitter = '<a href="' . htmlspecialchars($db[ 'twitter' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-twitter fa-2x fa-fw"></i></a>';
        } else {
            $twitter = 'n_a';
        }

        if ($db[ 'youtube' ] != '') {
            $youtube = '<a href="' . htmlspecialchars($db[ 'youtube' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-youtube fa-2x fa-fw"></i></a>';
        } else {
            $youtube = 'n_a';
        }

        if ($db[ 'rss' ] != '') {
            $rss = '<a href="' . htmlspecialchars($db[ 'rss' ]) . '" target="_blank" rel="nofollow"><i class="fas fa-rss fa-2x fa-fw"></i></a>';
        } else {
            $rss = 'n_a';
        }

        if ($db[ 'vine' ] != '') {
            $vine = '<a href="' . htmlspecialchars($db[ 'vine' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-vine fa-2x fa-fw"></i></a>';
        } else {
            $vine = 'n_a';
        }

        if ($db[ 'flickr' ] != '') {
            $flickr = '<a href="' . htmlspecialchars($db[ 'flickr' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-flickr fa-2x fa-fw"></i></a>';
        } else {
            $flickr = 'n_a';
        }

        if ($db[ 'linkedin' ] != '') {
            $linkedin = '<a href="' . htmlspecialchars($db[ 'linkedin' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-linkedin-in fa-2x fa-fw"></i></a>';
        } else {
            $linkedin = 'n_a';
        }

        if ($db[ 'instagram' ] != '') {
            $instagram = '<a href="' . htmlspecialchars($db[ 'instagram' ]) . '" target="_blank" rel="nofollow"><i class="fab fa-instagram fa-2x fa-fw"></i></a>';
        } else {
            $instagram = 'n_a';
        }
...
if(mysqli_num_rows($ergebnis)){
    while ($ds = mysqli_fetch_array($ergebnis)) {
        ...
        if ($ds[ 'navilink1' ] != '') {
            $navilink1 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink1' ]) . '" '.$windows1.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname1' ]) . '</a></li>';
        } else {
            $navilink1 = '';
        }

        if ($ds[ 'navilink2' ] != '') {
            $navilink2 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink2' ]) . '" '.$windows2.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname2' ]) . '</a></li>';
        } else {
            $navilink2 = '';
        }

        if ($ds[ 'navilink3' ] != '') {
            $navilink3 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink3' ]) . '" '.$windows3.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname3' ]) . '</a></li>';
        } else {
            $navilink3 = '';
        }

        if ($ds[ 'navilink4' ] != '') {
            $navilink4 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink4' ]) . '" '.$windows4.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname4' ]) . '</a></li>';
        } else {
            $navilink4 = '';
        }

        if ($ds[ 'navilink5' ] != '') {
            $navilink5 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink5' ]) . '" '.$windows5.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname5' ]) . '</a></li>';
        } else {
            $navilink5 = '';
        }

        if ($ds[ 'navilink6' ] != '') {
            $navilink6 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink6' ]) . '" '.$windows6.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname6' ]) . '</a></li>';
        } else {
            $navilink6 = '';
        }

        if ($ds[ 'navilink7' ] != '') {
            $navilink7 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink7' ]) . '" '.$windows7.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname7' ]) . '</a></li>';
        } else {
            $navilink7 = '';
        }

        if ($ds[ 'navilink8' ] != '') {
            $navilink8 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink8' ]) . '" '.$windows8.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname8' ]) . '</a></li>';
        } else {
            $navilink8 = '';
        }

        if ($ds[ 'navilink9' ] != '') {
            $navilink9 = '<li class="list-group-item list-footer"><i class="fas fa-angle-right text-white"></i> <a href="' . htmlspecialchars($ds[ 'navilink9' ]) . '" '.$windows9.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname9' ]) . '</a></li>';
        } else {
            $navilink9 = '';
        }

        if ($ds[ 'navilink10' ] != '') {
            $navilink10 = '<li class="list-group-item list-footer"><i class="fas fa-angle-double-right"></i> <a href="' . htmlspecialchars($ds[ 'navilink10' ]) . '" '.$windows10.' rel="nofollow">' . htmlspecialchars($ds[ 'linkname10' ]) . '</a></li>';
        } else {
            $navilink10 = '';
        }
