...
(1, '{[de]}Webseiten Info - Einstellungen{[en]}Website Info - Settings{[it]}Informazioni-Impostazioni Sito', 'fas fa-chart-bar', 'any', 0, 1),
...
(8, '{[de]}Grafik - Video - Projekte{[en]}Grafik - Video - Projekte{[it]}Grafica - Video - Progetti', 'fa fa-video ', 'gallery', 0, 8),
(9, '{[de]}Header - Slider{[en]}Header - Slider{[it]}Slider-Header', 'fa fa-image', 'page', 0, 9),
(10, '{[de]}Game - Voice Server Tools{[en]}Game - Voice Server Tools{[it]}Voice Server Tools', 'fa fa-gamepad', 'clanwars', 0, 10),
(11, '{[de]}Social Media{[en]}Social Media{[it]}Social Media', 'fab fa-steam', 'feedback', 0, 11),
(12, '{[de]}Links - Download - Sponsoren{[en]}Links - Download - Sponsore{[it]}Link - Download - Sponsor', 'fa fa-link', 'any', 0, 12)");
...
(21, 5, '{[de]}Templates - Style{[en]}Templates - Style{[it]}Templates Grafici', 'ac_templates', 'admincenter.php?site=settings_templates', 'page', 3),
(22, 5, '{[de]}Head Elements{[en]}Head Elements{[it]}Elementi Head', 'ac_headelements', 'admincenter.php?site=settings_headelements', 'page', 4),
...
(30, 7, '{[de]}Footer{[en]}Footer{[it]}Elementi Footer', 'footer', 'admincenter.php?site=admin_footer', 'page', 1)");
...
##############################################################################################################################
if ($transaction->successful()) {
        return array('status' => 'success', 'message' => '- Install successful for Webspell RM Database: <span class="badge bg-success">"plugins_footer"</span>');
    } else {
        return array('status' => 'fail', 'message' => '- Failed to install Webspell-RM<br/>' . $transaction->getError());
    }
}
...
$transaction->addQuery("INSERT INTO `".PREFIX."settings_module` (`pluginID`, `name`, `modulname`, `themes_modulname`, `full_activated`, `head_activated`, `content_head_activated`, `content_foot_activated`, `head_section_activated`, `foot_section_activated`, `modul_display`, `activate`, `sidebar`, `plugin_settings`, `plugin_module`, `plugin_widget`, `widget1`, `widget2`, `widget3`) VALUES
(1, 'Startpage', '', 'default', 0, 0, 0, 0, 0, 0, 0, 1, 'activated', 0, 1, 0, 0, 0, 0),
(2, '', 'startpage', 'default', 0, 0, 0, 0, 0, 0, 1, 1, 'activated', 0, 1, 0, 0, 0, 0),
...
(15, 'Navigation Default', 'navigation_default', 'default', 0, 0, 0, 0, 0, 0, 1, 1, 'activated', 1, 0, 1, 1, 0, 0),
(16, 'Footer', 'footer', 'default', 0, 0, 0, 0, 0, 0, 1, 1, 'activated', 1, 0, 1, 1, 1, 1)");
...
(14, 'Navigation Default', 'navigation_default', '{[de]}Mit diesem Plugin k&#246;nnt ihr euch die Default Navigation anzeigen lassen.{[en]}With this plugin you can display the default navigation. ', '', 1, 'T-Seven', 'https://webspell-rm.de', '', '', '0.1', 'includes/plugins/navigation_default/', 'Navigation Default', '', '', 'widget_navigation_default', '', '', 1),
...
##############################################################################################################################
if ($transaction->successful()) {
        return array('status' => 'success', 'message' => '- Install successful for Webspell RM Database: <span class="badge bg-success">"settings_plugins"</span>');
    } else {
        return array('status' => 'fail', 'message' => '- Failed to install Webspell-RM<br/>' . $transaction->getError());
    }
}
...
(1, 'page_navigation_widget', 'page_navigation_widget', 'navigation_default', 'default', 'widget1', 0, 'Navigation Default', 'widget_navigation_default', 0, 1),
(2, 'page_footer_widget', 'page_footer_widget', 'footer', 'default', 'widget2', 0, 'Easy Footer Content', 'widget_easyfooter_content', 0, 1)");

##############################################################################################################################
##############################################################################################################################
if ($transaction->successful()) {
        return array('status' => 'success', 'message' => '- Install successful for Webspell RM Database: <span class="badge bg-success">"settings_widgets"</span>');
    } else {
        return array('status' => 'fail', 'message' => '- Failed to install Webspell-RM<br/>' . $transaction->getError());
    }
}
...
##############################################################################################################################
if ($transaction->successful()) {
        return array('status' => 'success', 'message' => '- Install successful for Webspell RM Database: <span class="badge bg-success">"user"</span> <span class="badge bg-success">"user_forum_groups"</span> <span class="badge bg-success">"user_groups"</span> <span class="badge bg-success">"user_nickname"</span> <span class="badge bg-success">"user_visitors"</span>');
    } else {
        return array('status' => 'fail', 'message' => '- Failed to install Webspell-RM<br/>' . $transaction->getError());
    }
}
...
##############################################################################################################################
 if ($transaction->successful()) {
      return array('status' => 'success', 'message' => '- Webspell-RM Installation Ver.: <span class="badge bg-warning">2.1.4</span> / <b>Last Stand:</b> <span class="badge bg-warning">25.09.2023</span>');
  } else {
      return array('status' => 'fail', 'message' => '-  Webspell-RM Installation Ver.: <b>2.1.4 / <b>Last Stand:</b> 25.09.2023<br/>' . $transaction->getError());
  }
