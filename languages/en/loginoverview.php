...
/* do not edit above this line */
    ...
    'menu' => 'Usermenu',
    'views' => 'views',
    'you_have_to_be_logged_in' => '<blockquote>You have to be logged in to view the login overview!<br><br>
     <a class="btn btn-primary" href="index.php?site=register">register now</a> <a class="btn btn-success" href="index.php?site=login">log in</a>',
