...
$language_array = Array(
  ...
  'error'					=> '<p class="text-danger"><i class="fas fa-exclamation-triangle"></i> Il server di aggiornamento è offline!</p>',
  'new_version_available'	=> '<p class="text-warning"><i class="fas fa-exclamation-triangle"></i>È disponibile una nuova versione di webspell!</p>Aggiorna il tuo sistema.',
  'update_info1'			=> '<p class="text-success">La tua versione è quella attuale <i class="fas fa-check text-success"></i></p>',
  'update_info2'			=> '<p class="text-danger">La tua versione è superiore a quella di Webspell-RM.</p><i class="fas fa-exclamation-triangle text-danger"> </i > Contatta il team webspell!',
